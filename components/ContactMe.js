...
function ContactMe() {
  return (
    ...
    max-w-7xl  px-10 justify-evenly max-sm:justify-center max-sm:px-1 mx-auto items-center max-sm::mb-14"
    >
      <h3 className="absolute  top-12 uppercase tracking-[20px] text-gray-500 text-2xl">
        Contact
      </h3>
      <div className="flex flex-col space-y-10 max-sm:space-y-2">
        ...
        <div className="space-y-10 max-sm:space-y-4">
      ...
      >
        <div className="flex max-sm:flex-col w-full space-x-2 max-sm:space-x-0 max-sm:space-y-2">
          <input
            ...
            placeholder="Name"
            type={"text"}
            className="contactInput max-sm:px-8 max-sm:py-2"
          />
          <input
            // value={emailInp}
        ...
        <button
          type="submit"
          className="bg-[#F7AB0A] max-sm:px-8 max-sm:py-2  py-5 px-10 rounded-md text-black font-bold text-lg"
        >
          Submit
        </button>
      </form>
